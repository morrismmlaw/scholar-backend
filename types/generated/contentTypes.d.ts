...
export interface ApiProfileProfile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    biography: Schema.Attribute.RichText &
      ...
      >;
    chiname: Schema.Attribute.String &
    ...
    publishedAt: Schema.Attribute.DateTime;
    research_interest: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
        {
          preset: 'default';
      ...
      >;
    salute: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiStaffStaff extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    othername: Schema.Attribute.String;
    post: Schema.Attribute.String;
    postabbr: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    research_interest: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        'plugin::ckeditor5.CKEditor',
